...
public class NetUtil {
    ...
    /**
     * 判定是否为内网IP<br> 私有IP：A类 10.0.0.0-10.255.255.255 B类 172.16.0.0-172.31.255.255 C类 192.168.0.0-192.168.255.255
     * 当然，还有127这个网段是环回地址
     *
    ...
    /**
     * 构建InetSocketAddress<br> 当host中包含端口时（用“：”隔开），使用host中的端口，否则使用默认端口<br> 给定host为空时使用本地host（127.0.0.1）
     *
     * @param host        Host
    ...
    /**
     * 获得本机的IP地址列表<br> 返回的IP列表有序，按照系统设备顺序
     *
